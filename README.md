...
Aligning short reads to reference sequences (HW5); scripts used located in scripts folder and .rmd file providing final statistical summary of alignment <br>

**Actions pending** <br>
Variant calling from alignments (HW6); tutorial in action
